...
import { FaChevronDown, FaUserShield, FaSignOutAlt, FaCog, FaTachometerAlt } from 'react-icons/fa';
          ...
          <div className="hidden md:flex items-center space-x-2">
            ...
            {!isAdmin ? (
              ...
              <div className="flex items-center ml-6">
                {/* Oval badge with admin name and role */}
                <div className="relative flex items-center bg-white/10 border border-white/20 rounded-full px-5 py-2 shadow-lg">
                  <span className="font-semibold text-white mr-3 flex items-center">
                    <FaUserShield className="w-4 h-4 mr-1 text-cyan-300" />
                    {user.name}
                  </span>
                  ...
                  <AnimatePresence>
                    {isUserMenuOpen && (
                      ...
                      >
                        ...
                        >
                          <FaTachometerAlt className="w-4 h-4 mr-2" /> Admin Dashboard
                        </Link>
                        <Link
